...
TOKEN = '6548444151:AAGJ_whSeGvP7vFe1C1VOz8QdBCunpCpOyM'
app = Client("remymbot",
  api_id=12962251, api_hash="b51499523800add51e4530c6f552dbc8",
  bot_token=TOKEN, 
)
bot_id = app.bot_token.split(":")[0]

# Get ur redis url from https://app.redislabs.com/
r = redis.from_url('redis://default:FxQ32tSLxtCe3iq6Vqdu4c9NA3Vv7nLI@redis-12179.c273.us-east-1-2.ec2.cloud.redislabs.com:12179')
